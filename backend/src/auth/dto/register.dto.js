...
var RegisterDto = function () {
    ...
    return _a = /** @class */ (function () {
            function RegisterDto() {
                this.email = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _email_initializers, ''));
                this.password = __runInitializers(this, _password_initializers, '');
                this.nombre = __runInitializers(this, _nombre_initializers, '');
            }
            return RegisterDto;
        }()),
        (function () {
            ...
            __esDecorate(null, null, _nombre_decorators, { kind: "field", name: "nombre", static: false, private: false, access: { has: function (obj) { return "nombre" in obj; }, get: function (obj) { return obj.nombre; }, set: function (obj, value) { obj.nombre = value; } }, metadata: _metadata }, _nombre_initializers, _instanceExtraInitializers);

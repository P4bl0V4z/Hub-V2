...
export const sistema_gestion: QuestionsMap = {
  Q_SG_ADHERIDO: {
    ...
    title: "¿Está adherido a un Sistema de Gestión REP?",
    type: "single",
    options: [
      // Si está adherido, preguntamos por declaraciones
      { label: "Sí", value: "si", next: "Q_SG_DECLARADO" },
      // CAMBIO: si NO está adherido, saltamos directo a VU – RETC
  ...
  Q_SG_DECLARADO: {
    id: "Q_SG_DECLARADO",
    sectionKey: "sistema_gestion",
    title: "¿Has realizado declaraciones en un sistema de gestión REP?",
    type: "single",
    options: [

            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Basado En Sus Respuestas, {stage === "transicion" ? "Presentamos Una Evaluación Del Nivel De Cumplimiento De Su Empresa Respecto A Los Distintos Hitos Establecidos, Identificando Avances Y Áreas Por Mejorar." : "HEMOS EVALUADO EL ESTADO DE SU EMPRESA CON RESPECTO A LOS SIGUIENTES HITOS"}
                </p>
              </div>
            </div>
            ...
            <div className="border rounded-lg p-4">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Badge variant="secondary">{completedSteps} DE 5 HITOS COMPLETADOS</Badge>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <div className="w-4 h-4 bg-black rounded-full mt-1 flex-shrink-0"></div>
                  <div>
                    <h5 className="font-medium text-sm">RUTA VENTANILLA ÚNICA RETC</h5>
                    <p className="text-sm text-gray-600">Registra tu establecimiento en RETC</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h5 className="font-medium text-sm">RUTA VENTANILLA ÚNICA RETC</h5>
                    <p className="text-sm text-gray-600">
                      Caracteriza tus procesos productivos, identificando todas las fuentes de emisión, residuos y 
                      transferencias
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h5 className="font-medium text-sm">RUTA VENTANILLA ÚNICA RETC</h5>
                    <p className="text-sm text-gray-600">Apertura Todos Los Sistemas Sectoriales Pertinentes</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h5 className="font-medium text-sm">RUTA VENTANILLA ÚNICA RETC</h5>
                    <p className="text-sm text-gray-600">
                      Completa La Declaración Anual De Emisiones, Residuos Y Transferencias En Plataforma RETC
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h5 className="font-medium text-sm">RUTA VENTANILLA ÚNICA RETC</h5>
                    <p className="text-sm text-gray-600">
                      Somete Tu Declaración A Verificación Externa, Obtén Aprobación Ministerial Y Asegura La Publicación 
                      Del Reporte.
                    </p>
                  </div>
                </div>
